...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
     ...
     if ($myForm->validateFields($valRules, $_POST)) {
          ...
          if ($result) {
               ...
               $query = "INSERT INTO users (	user_id, fullName,	email, password, phone, address, country, company_name,state)
               VALUES(:user_id, :fullName, :email, :password,:phone, :address, :country, :company_name,:state)";
               $data = [
                    'user_id' => $user_id,
                    'fullName' => $fullName,
                    'email' => $email,
...
<div class="wrapper fadeInDown formSection">
     <div id="formContent">
          ...
          <form id="register" action="" method="post" autocomplete="off">
               ...
               <input type="text" id="companyName" class="fadeIn second" name="com_name" placeholder="Company Name optional">

               <!-- country should come here  -->
               <label for="country">Country</label><span style="color: red !important; display: inline; float: none;">*</span>

               <select id="country" name="country" class="form-control fadeIn second">
               ...
               <!-- end of country -->
               <input type="text" id="state" class="fadeIn second" name="state" placeholder="State">
